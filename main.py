...
# Кыскача эмоционалдуу ыр саптары, цитаталар жана терең маанилүү текстер (Орус тилинде)
MESSAGES = [
...
# Сиз каалаган сүрөт категориялары (BMW, Кара спорт автолор, Романтикалуу түгөйлөр)
KEYWORDS = [
    "bmw,m4,blackcar",
...
def send_post():
    try:
        ...
        print("Эмоционалдуу пост саат сайын жөнөтүлдү!")
    except Exception as e:
        print(f"Ката чыкты: {e}")

# Так 1 саатта 1 жолу жөнөтүү графиги
schedule.every(1).hours.do(send_post)

if __name__ == '__main__':
    threading.Thread(target=run_flask).start()
    
    # Бот иштегенде дароо 1-постту жөнөтөт
    send_post()
